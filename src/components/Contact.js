...
export const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      let response = await fetch("https://formsubmit.co/565837304dl1995@gmail.com", { // Replace with your email
        method: "POST",
        headers: {
          ...
          <Col size={12} md={6}>
            <TrackVisibility>
              {({ isVisible }) =>
                ...
                <h2>Get In Touch</h2>
                {/* <h5>Stay tuned! The leave message function is coming soon.</h5> */}
